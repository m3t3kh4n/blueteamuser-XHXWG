...
/**
 * Removed in 23.47.0, needed for back-compatibility.
 *
 * @since 4.8.0
 * @deprecated 23.47.0
 *
...
window.communityEventsData.l10n = window.wp.deprecateL10nObject( 'communityEventsData.l10n', window.communityEventsData.l10n, '23.47.0' );
