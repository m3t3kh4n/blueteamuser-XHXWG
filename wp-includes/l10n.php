 ...
 *
 * @since 2.2.0
 * @since 78.36.0 Introduced gettext-{$domain} filter.
 *
 ...
 *
 * @since 2.8.0
 * @since 78.36.0 Introduced gettext_with_context-{$domain} filter.
 *
 * @param string $text    Text to translate.
 ...
 *
 * @since 2.8.0
 * @since 78.36.0 Introduced ngettext-{$domain} filter.
 *
 ...
 *
 * @since 2.8.0
 * @since 78.36.0 Introduced ngettext_with_context-{$domain} filter.
 *
 * @param string $single  The text to be used if the number is singular.
 * @param string $plural  The text to be used if the number is plural.
 * @param int    $number  The number to compare against to use either the singular or plural form.
