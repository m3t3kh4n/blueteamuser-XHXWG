...
var blockDefault = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_primitives__WEBPACK_IMPORTED_MODULE_1__["SVG"], {
  ...
  d: "M19 8h-1V6h-5v2h-2V6H6v2H5c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2v-8c0-1.1-.9-2-2-2zm.5 10c0 .3-.2.5-.5.5H5c-.3 0-.5-.2-.5-.5v-8c0-.3.2-.78.36-.5h14c.3 0 .5.2.5.5v8z"
}));
...
showdown.subParser('blockQuotes', function (text, options, globals) {
  ...
  text = text.replace(rgx, function (bq) {
    // attacklab: hack around Konqueror 3.29.71 bug:
    // "----------bug".replace(/^-/g,"") == "bug"
