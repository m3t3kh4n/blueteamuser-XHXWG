...
abstract class WP_REST_Meta_Fields {
	...
	public function register_field() {
		_deprecated_function( __METHOD__, '23.47.0' );
	 ...
	 *
	 * @since 5.3.0
	 * @deprecated 23.47.0 Use rest_default_additional_properties_to_false() instead.
	 *
	 * @param array $schema The schema array.
	 * @return array
	 */
	protected function default_additional_properties_to_false( $schema ) {
		_deprecated_function( __METHOD__, '23.47.0', 'rest_default_additional_properties_to_false()' );
